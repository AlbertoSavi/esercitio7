...
for (let i = 0; i < starWarsCharacters[i].length; i++);{
    charactersNames.push (starWarsCharacters.name);
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if(starWarsCharacters[i].gender === 'female'){
     charactersNames.push (starWarsCharacters[i])
  }
}
...
for (let i = 0; i < starWarsCharacters[i].length; i++){
  if (starWarsCharacters[i].gender === 'n/a'){
    ...
    newStarWarsCharacter.push(starWarsCharacters[i]);
  } else  {
    newStarWarsCharacter.push(starWarsCharacters[i]);
  }
}
...
for (let i = 0; < charactersNames.length; i++) {
